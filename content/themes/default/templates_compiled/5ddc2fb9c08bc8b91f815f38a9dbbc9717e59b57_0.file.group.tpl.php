<?php
/* Smarty version 4.3.0, created on 2023-01-20 23:33:10
  from '/home/769987.cloudwaysapps.com/cnpchtvcsh/public_html/content/themes/default/templates/group.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.0',
  'unifunc' => 'content_63cb24b603dc14_84321501',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '5ddc2fb9c08bc8b91f815f38a9dbbc9717e59b57' => 
    array (
      0 => '/home/769987.cloudwaysapps.com/cnpchtvcsh/public_html/content/themes/default/templates/group.tpl',
      1 => 1673723815,
      2 => 'file',
    ),
  ),
...
function content_63cb24b603dc14_84321501 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'/home/769987.cloudwaysapps.com/cnpchtvcsh/public_html/vendor/smarty/smarty/libs/plugins/modifier.number_format.php','function'=>'smarty_modifier_number_format',),));
...
/members"><?php echo $_smarty_tpl->tpl_vars['group']->value['group_members'];?>
 <?php echo __("members");?>
                  ...
                  <li>
                    <div class="about-list-item">
                      <i class="fa fa-newspaper fa-fw fa-lg"></i><?php echo __($_smarty_tpl->tpl_vars['group']->value['posts_count']);?>
 <?php echo __("Posts");?>
                  ...
                  <li>
                    <div class="about-list-item">
                      <i class="fa fa-images fa-fw fa-lg"></i><?php echo __($_smarty_tpl->tpl_vars['group']->value['photos_count']);?>
 <?php echo __("Photos");?>
                  ...
                  <li>
                    <div class="about-list-item">
                      <i class="fa fa-video fa-fw fa-lg"></i><?php echo __($_smarty_tpl->tpl_vars['group']->value['videos_count']);?>
 <?php echo __("Videos");?>
...
/subscribers"><?php echo __("Subscribers");?>
                  ...
                  <span class="badge badge-pill badge-info ml5"><?php echo $_smarty_tpl->tpl_vars['group']->value['subscribers_count'];?>
</span>
                </div>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
          ...
          <div class="order-2 col-lg-8 order-lg-1">
            <?php if ($_smarty_tpl->tpl_vars['group']->value['needs_subscription']) {?>
              <?php $_smarty_tpl->_subTemplateRender('file:_need_subscription.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('node_type'=>'group','node_id'=>$_smarty_tpl->tpl_vars['group']->value['group_id'],'price'=>$_smarty_tpl->tpl_vars['group']->value['group_monetization_price']), 0, false);
?>
            <?php } else { ?>
              <!-- super admin alert -->
...
?>
        ...
        <?php } elseif ($_smarty_tpl->tpl_vars['view']->value == "photos") {?>
          ...
          <div class="col-12">
            <?php if ($_smarty_tpl->tpl_vars['group']->value['needs_subscription']) {?>
              <?php $_smarty_tpl->_subTemplateRender('file:_need_subscription.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('node_type'=>'group','node_id'=>$_smarty_tpl->tpl_vars['group']->value['group_id'],'price'=>$_smarty_tpl->tpl_vars['group']->value['group_monetization_price']), 0, true);
?>
            <?php } else { ?>
              <div class="card panel-photos">
...
/subscribers">
                      ...
                      <span class="badge badge-pill badge-info"><?php echo $_smarty_tpl->tpl_vars['group']->value['subscribers_count'];?>
</span>
                    </a>
                  </li>
                  <li class="nav-item">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                  ...
                  <?php if (count($_smarty_tpl->tpl_vars['group']->value['subscribers']) >= $_smarty_tpl->tpl_vars['system']->value['max_results_even']) {?>
                    <!-- see-more -->
                    <div class="alert alert-info see-more mt0 mb20 js_see-more" data-get="subscribers" data-uid="<?php echo $_smarty_tpl->tpl_vars['group']->value['group_id'];?>
" data-type="group">
                      <span><?php echo __("See More");?>
</span>
                      <div class="loader loader_small x-hidden"></div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header with-icon with-nav">
                <!-- panel title -->
                <div class="mb20">
                  <i class="fa fa-users mr10"></i><?php echo __("Invites");?>
...
/groups/<?php echo $_smarty_tpl->tpl_vars['group']->value['group_name'];?>
/settings">
                      <i class="fa fa-cog fa-fw mr5"></i><?php echo __("Group Settings");?>
...
/groups/<?php echo $_smarty_tpl->tpl_vars['group']->value['group_name'];?>
/settings/requests">
                        <i class="fa fa-user-plus fa-fw mr5" style="color: #2b53a4;"></i><?php echo __("Join Requests");?>
...
/groups/<?php echo $_smarty_tpl->tpl_vars['group']->value['group_name'];?>
/settings/members">
                      <i class="fa fa-users fa-fw mr5" style="color: #8bc34a"></i><?php echo __("Members");?>
...
/groups/<?php echo $_smarty_tpl->tpl_vars['group']->value['group_name'];?>
/settings/delete">
                        <i class="fa fa-trash fa-fw mr5" style="color: #f44336;"></i><?php echo __("Delete Group");?>
...
<br>
              ...
              <?php } elseif ($_smarty_tpl->tpl_vars['sub_view']->value == "requests") {?>
                <div class="card-header with-icon">
                  <i class="fa fa-user-plus mr10" style="color: #2b53a4;"></i><?php echo __("Member Requests");?>
...
">
              ...
              <?php } elseif ($_smarty_tpl->tpl_vars['sub_view']->value == "members") {?>
                <div class="card-header with-icon">
                  <i class="fa fa-users mr10" style="color: #8bc34a"></i><?php echo __("Members");?>
...
">
 ...
 <?php echo __("doesn't have members");?>
              ...
              <?php } elseif ($_smarty_tpl->tpl_vars['sub_view']->value == "monetization") {?>
                <div class="card-header with-icon">
                  <i class="fa fa-comment-dollar mr10" style="color: #e91e63;"></i><?php echo __("Monetization");?>
 ...
 <strong><span class="badge badge-pill badge-warning"><?php echo $_smarty_tpl->tpl_vars['system']->value['monetization_commission'];?>
...
?>
 ...
 (<?php echo $_smarty_tpl->tpl_vars['system']->value['system_currency'];?>
                        ...
                        <div class="col-md-9">
                          <input type="text" class="form-control" name="group_monetization_price" value="<?php echo $_smarty_tpl->tpl_vars['group']->value['group_monetization_price'];?>
">
                          <span class="form-text">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="section-title mb20">
                          <i class="fas fa-users mr10"></i><?php echo __("Group Subscribers");?>
                      ...
                      <div class="col-sm-6">
                        <div class="section-title mb20">
                          <i class="fa fa-donate mr10"></i><?php echo __("Monetization Money Balance");?>
              ...
              <?php } elseif ($_smarty_tpl->tpl_vars['sub_view']->value == "delete") {?>
                <div class="card-header with-icon">
                  <i class="fa fa-trash mr10" style="color: #f44336;"></i><?php echo __("Delete Group");?>
